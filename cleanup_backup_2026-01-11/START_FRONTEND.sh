...
echo "  • Dashboard (Option 1):       http://localhost:5173/"
echo "  • Property Details (Option 2): http://localhost:5173/properties/ESP001"
echo "  • NLQ Search:                 http://localhost:5173/nlq"
echo ""
