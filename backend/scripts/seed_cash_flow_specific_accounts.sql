--
-- Cash Flow Specific Accounts - Seed File
-- These accounts are specific to cash flow statements and handle:
-- - Non-cash adjustments (depreciation, amortization)
-- - Escrow accounts
-- - Inter-property accounts payable/receivable
-- - Additional operational categories
--
-- Created: 2025-11-06
-- Context: Added based on analysis of unmatched cash flow accounts
--
