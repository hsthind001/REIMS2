...
class AnomalyThresholdBase(BaseModel):
    ...
    threshold_value: Decimal = Field(..., description="Absolute value threshold for anomaly detection")
...
class AnomalyThresholdUpdate(BaseModel):
    ...
    threshold_value: Optional[Decimal] = Field(None, description="Absolute value threshold")
...
class DefaultThresholdResponse(BaseModel):
    ...
    default_threshold: Decimal = Field(..., description="Default absolute value threshold")
